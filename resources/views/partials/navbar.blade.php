                ...
                <div
                    ...
                    <div class="pt-12">
                        <ul class="bg-white list-disc text-nowrap pl-8 p-3 rounded-xl">
                            <li>
                                <a href="{{ route('sejarah') }}" class="w-full block pl-2 pr-8 py-1">Sejarah</a>
                            </li>
                            <li>
                                <a href="{{ route('visimisi') }}" class="w-full block pl-2 pr-8 py-1">Visi & Misi</a>
                            </li>
                            <li>
                                <a href="{{ route('sambutan') }}" class="w-full block pl-2 pr-8 py-1">Sambutan Rektor</a>
                            </li>
                            <li>
                                <a href="{{ route('fasilitas') }}" class="w-full block pl-2 pr-8 py-1">Fasilitas</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="bg-white flex gap-4 px-6 py-3 rounded-xl">
                            ...
                            <div class="px-4 flex-1">
                                ...
                                <ul class="text-nowrap space-y-1 list-disc">
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 PENDIDIKAN GURU
                                            SD</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#" class="w-full block pl-2 pr-8 py-1">S1 TEKNIK
                                            INFORMATIKA</a>
                                    </li>
                                </ul>
                            </div>
