        ...
        <div class="mt-10 space-y-11">
            @foreach ($lectures as $lecture)
                <div class="flex flex-col items-center sm:flex-row gap-8 sm:gap-16">
                    <img class="sm:col-span-2" src="{{ asset('storage/'. $lecture->image) }}" alt="{{ $lecture->nama }}" />
            ...
            @foreach ($admins as $admin)
                <div class="flex flex-col items-center sm:flex-row gap-8 sm:gap-16">
                    ...
                    <div class="sm:col-span-10 font-montserrat">
                        ...
                        <table class="table-fixed w-full sm:table-fixed font-medium text-xs sm:text-sm text-xneutral-300 mt-5">
                            <tbody>
                                <tr>
