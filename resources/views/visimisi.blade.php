    ...
    <article class="container mt-28">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
            <div class="space-y-3">
                ...
                <div class="text-lg sm:text-xl font-semibold font-montserrat text-xneutral-200 text-center uppercase">
            ...
            <div class="space-y-3">
                ...
                <ol class="list-decimal pl-4 font-montserrat font-semibold text-xneutral-200 text-sm sm:text-base text-justify">
