        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-12 md:gap-[124px] font-montserrat">
            <div class="space-y-10">
                <div class="flex flex-col gap-3">
                    ...
                    <input type="text" id="nama_lengkap" name="nama_lengkap" placeholder="Masukan Nama Lengkap Anda"
                        required
            ...
            <div class="space-y-10">
                <div class="flex flex-col gap-3">
                    ...
                    <input type="text" id="nama-panggilan" name="nama_panggilan"
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <input type="tel" id="nomor-hp" name="nomor_telepon" placeholder="Masukan Nomor HP Anda" required
                        class="border placeholder:font-semibold placeholder:text-xneutral-100 border-xneutral-100 py-[18px] px-6 rounded-lg" />
                </div>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex items-center">
                        <select id="program-studi-1" name="program_study1" required
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex items-center">
                        <select id="program-studi-2" name="program_study2" required
                            class="border peer appearance-none w-full placeholder:font-semibold placeholder:text-xneutral-100 border-xneutral-100 py-[18px] px-6 rounded-lg">
