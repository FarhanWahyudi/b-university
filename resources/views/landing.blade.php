...
@extends('content')
    ...
    <section class="container min-h-[90vh] relative mt-28">
        <div id="hero-1"
            ...
            <div class="px-4 md:pl-12 w-full lg:w-1/2 lg:portrait:w-full">
                ...
                <span class="text-lg md:text-xl text-white font-montserrat font-medium">Kami berkomitmen mendidik
        ...
        <div id="hero-2"
            ...
            <div class="px-4 md:pl-12 w-full lg:w-1/2 lg:portrait:w-full">
                ...
                <span class="text-lg md:text-xl text-white font-montserrat font-medium">Teknik pembelajaran yang
        ...
        <div id="hero-3"
            ...
            <div class="px-4 md:pl-12 w-full lg:w-1/2 lg:portrait:w-full">
                ...
                <span class="text-lg md:text-xl text-white font-montserrat font-medium">Kami hadir untuk membimbing
    ...
    <div class="container overflow-hidden w-fit md:px-16 py-5 rounded-3xl mx-4 sm:mx-auto -mt-32 bg-white z-10 relative shadow-2xl">
        <h3 class="text-xl sm:text-2xl text-center w-full font-semibold font-montserrat mb-4">
            Bekerjasama Dengan
        </h3>
        <div class="flex overflow-x-auto gap-16">
            @foreach ($cooperationImg as $data)
                <img class="w-12 md:w-fit" src="{{ asset('storage/' . $data->image) }}" alt="Cooperation" />
            @endforeach
        </div>
    </div>
    ...
    <section class="w-full overflow-hidden py-28">
        <div class="container grid grid-cols-1 md:grid-cols-2 items-center gap-12">
            <div class="space-y-4 lg:ml-20">
                ...
                <a href="#"
                    class="px-6 py-[14px] font-montserrat text-neutral-0 bg-white border w-fit text-lg font-semibold border-primary-200 text-primary-200 rounded-full flex gap-[10px]"><span>Tentang kami</span>
